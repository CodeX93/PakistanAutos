  ...
  const navigationItems = [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          text: 'Spare Parts',
          icon: <Factory />,
          path: '/admindashboard/inventory/spareparts',
        },
      ],
    },
    {
      ...
      children: [
        ...
        {
          id: 'soldspareParts',
          text: 'Sold Spare Parts',
          icon: <Factory />,
          path: '/admindashboard/soldInventory/soldSpareparts',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          text: 'Sell Parts',
          icon: <Build />,
          path: '/admindashboard/sales/sellParts'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        {
          id: 'manageSparePartSuppliers',
          text: 'Manage Spare Part Suppliers',
          icon: <Build />,
          path: '/admindashboard/partners/sparePartSuppliers',
        },
      ],
    },
    {
        ...
        <Main open={open}>
          ...
          >
            <Routes>
              ...
              <Route path="/admindashboard/inventory/spareparts" element={<SpareParts />} />

              {/* Sold Inventory */}
              <Route path="/admindashboard/SoldInventory/soldMotorcycles" element={<SoldMotorcycles />} />
              <Route path="/admindashboard/soldInventory/soldSpareparts" element={<SoldSparePart />} />
